 ...
 *
 * Data:
 * - event_name: {@link string} 
 * - event_date: {@link string} 
 * - event_location: {@link string} 
 * - ticket_type: {@link string} 
 * - ticket_seat: {@link string} 
 * - brief_description: {@link string} 
 */
    Mint = 0,
...
export const mint = (args: MintArgs): TransactionInstruction => {
    const data = serialize(
        ...
        },
        {
            ...
            event_location: args.eventLocation,
            ticket_type: args.ticketType,
            ticket_seat: args.ticketSeat,
            brief_description: args.briefDescription,
        }
    );
