...
pub fn mint(
	...
	ticket.data.event_name = event_name;
	ticket.data.event_date = event_date;
	ticket.data.event_location = event_location;
	ticket.data.ticket_type = ticket_type;
	ticket.data.ticket_seat = ticket_seat;
	ticket.data.brief_description = brief_description;
