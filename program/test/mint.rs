...
mod mint {
	...
	fn test_transaction_is_ok() {
		...
		let event_name: String = Default::default();
		let event_date: String = Default::default();
		let event_location: String = Default::default();
		let ticket_type: String = Default::default();
		let ticket_seat: String = Default::default();
		let brief_description: String = Default::default();
